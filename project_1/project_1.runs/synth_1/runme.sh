...
HD_PWD='G:/Sem5/CSD/Processor project/Src files/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_add_only.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_add_only.tcl
